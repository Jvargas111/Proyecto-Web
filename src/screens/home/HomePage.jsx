...
const HomePage = () => {
  ...
  return (
    <div className='flex flex-col justify-start min-h-screen my-5'>
      <div className='flex justify-center p-3 bg-gray-200 border border-solid border-gray-300'>
      ...
      <div className='w-full h-auto mt-6 border border-solid border-gray-300'>
        <img src='/public/portada.png' alt='Main' />
      </div>
      <footer className='mt-6 flex justify-around p-18 bg-gray-200 text-orange-400 text-2xl border border-solid border-gray-300'>
